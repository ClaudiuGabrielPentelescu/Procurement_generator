    ...
    <div className="footer-container">
      <section className="footer-subscription">
        <p className="footer-subscription-heading">
          Încearcă aplicația web Nota_rX pentru a vedea cât de repede îți poți redacta actul.
        </p>
        <p className="footer-subscription-text">Nu durează mai mult de 5 minute.</p>
        <div className="input-areas">
          <form>
            <input className="footer-input" name="email" type="email" placeholder="Emailul tău" />
            <Button buttonStyle="btn--outline">Trimite</Button>
          </form>
        </div>
      </section>
      ...
      <section class="social-media">
        <div class="social-media-wrap">
          ...
          <small class="website-rights">Nota_rX © 2023</small>
